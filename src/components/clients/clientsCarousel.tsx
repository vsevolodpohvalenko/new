                ...
                {clients_representatives.map((e: any, i: number) => <div {...settings} className={s.slide_wrapper} key={i}>
                        <div className={s.slide}>
                            <div {...settings} className={[s.slide_left].join(" ")}><h4 className={s.subheading}>WHAT OUR CLIENTS
                                SAY</h4></div>
                            <img  alt={'Shape'} className={s.comma} src={'https://assets.website-files.com/5d2593d4e31f05ed4edd50f5/5d5be935da745a6d959c72b0_Combined%20Shape.svg'}/>
                            <div   className={s.quote}><p>{e.quote}</p></div>
                            <img  alt={e.avatar} className={s.avatar} src={e.avatar}/>
                            ...
                            <div className={s.youtube}>
                                <img alt={'youtube'} src={'https://assets.website-files.com/5d2593d4e31f05ed4edd50f5/5d5be89ebb48f71c826c6f7a_youtube.svg'}/>
                                <a href={e.youtube} rel="noreferrer" target="_blank" className={s.link}>Watch video Feedback</a>
                            </div>
                            </div>
                                <img alt={'logo'} className={s.logo} src={e.logo}/>
                        </div>
                    </div>
                )}
            </Slider>
